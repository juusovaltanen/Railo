  ...
  const posts = [
    ...
    },
    {
      ...
      content: `
        ...
        <h3 class="text-white font-black uppercase italic mt-8 mb-4">Pölynsidonta on järkevä valinta teknisiin tiloihin</h3>
        <p>Jos tavoitteenasi on puhtaasti pitää tila siistinä ja estää hienojakoisen betonipölyn kantautuminen muihin tiloihin, pölynsidonta on kustannustehokkain ratkaisu. Se imeytyy syvälle betoniin ja kovettaa sen pinnan, mikä tekee lattiasta helpon puhdistaa. Vaikka pölynsidonta on suunniteltu kevyempään käyttöön, se toimii hyvin myös autotalleissa, kunhan muistat laittaa auton renkaiden alle kumimatot. Matot suojaavat pintaa nastojen mekaaniselta kulutukselta ja pidentävät käsittelyn kestoa merkittävästi.</p>
        <h3 class="text-white font-black uppercase italic mt-8 mb-4">Tyyliä ja puhtautta 0,5 mm ohutkalvopinnoituksella</h3>
        <p>Kun haluat autotalliisi tyylikkään väripinnan ja täydellisen tiiviyden, 0,5 mm ohutkalvopinnoitus on erinomainen valinta. Se antaa betonille ammattimaisen ilmeen ja on erittäin helppo pitää puhtaana. Tässäkin vaihtoehdossa suosittelemme kumimattojen käyttöä renkaiden alla, jotta pinnoite säilyy uudenveroisena. Kumimatot ottavat vastaan nastojen raapimisen ja kuumien renkaiden aiheuttaman rasituksen, jolloin itse pinnoite pysyy ehjänä ja näyttävänä.</p>
        <h3 class="text-white font-black uppercase italic mt-8 mb-4">Hiekka tekee kestävyyden – 1 mm ja 2 mm pinnoitteet</h3>
        <p>Kaikkein vaativimpiin kohteisiin, joissa lattialta vaaditaan maksimaalista kestävyyttä ilman kompromisseja, asennamme 1 mm ja 2 mm paksuisia pinnoitteita. Näiden massapinnoitteiden ylivertainen lujuus perustuu niissä täyteaineena käytettävään erikoishiekkaan. Hiekka muodostaa pinnoitteen rungon, joka tekee siitä erittäin iskunkestävän ja mekaanisesti vahvan.</p>
        ...
        {selectedPost ? (
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter italic leading-tight mb-8">
                {selectedPost.title}
              </h1>
              <div 
          ...
          <>
            <div className="text-center mb-16">
              <h1 className="text-5xl font-black text-white mb-6 uppercase tracking-tighter italic">Blogi</h1>
