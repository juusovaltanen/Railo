  ...
  const projects: ServiceCard[] = [
    {
      ...
      category: 'Autotallit',
      location: 'Liminka',
      description: 'Toteutimme Limingassa 40m² autotallin täydellisen lattiapäivityksen. Projekti aloitettiin huolellisella lattian hionnalla, jolla varmistettiin optimaalinen tartunta. Pintaan asennettiin kestävä ja tyylikäs Railo Kova Kulutus -epoksilattia, joka antaa tallille upean ulkonäön lisäksi erinomaisen suojan mekaanista kulutusta ja nastarenkaita vastaan.',
      tags: [],
    ...
    },
    {
      ...
      category: 'Teollisuus',
      location: 'Liminka',
      description: 'Limingassa sijaitsevan varastohallin lattia sai uuden elämän järeällä Railo Kova Kulutus -massalattialla. Tämä pinnoite on suunniteltu kestämään äärimmäistä mekaanista rasitusta ja raskasta kalustoa. Lopputuloksena on saumaton, helposti puhdistettava ja teollisuuskäyttöön täydellisesti soveltuva kestävä pinta.',
      tags: [],
